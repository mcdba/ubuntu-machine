...
Capistrano::Configuration.instance.load {load("#{File.dirname(__FILE__)}/ubuntu-machine/mediamountain.rb")}
Capistrano::Configuration.instance.load {load("#{File.dirname(__FILE__)}/ubuntu-machine/monit.rb")}
